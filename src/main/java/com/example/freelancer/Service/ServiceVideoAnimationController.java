...
public class ServiceVideoAnimationController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        service = DBUtils.getService("Video&Animations");
        ...
        if (i < k) {
            ...
            imgView1.setOnMousePressed(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    serviceSelectController.getServiceType("Video&Animations");
