...
public class ServiceDigitalMarketingController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        service = DBUtils.getService("Digital Marketing");
        ...
        if (i < k) {
            ...
            imgView1.setOnMousePressed(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent mouseEvent) {
                    ...
                    serviceSelectController.getServiceType("Digital Marketing");
